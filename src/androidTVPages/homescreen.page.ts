...
export class HomeScreenPage extends BasePage {
    ...
    getSettingsButtonElement() {
        return `//android.widget.Button[@resource-id='com.philo.philo.google:id/settings_button']`;
    }
    ...
    public selectors = {
        ...
        profilesRecyclerView: 'android=resourceId("com.philo.philo.google:id/recycler_view")',
        profileAvatar: 'android=resourceId("com.philo.philo.google:id/avatar")',
        profileLabel: 'android=resourceId("com.philo.philo.google:id/label")',
        addNewProfile: 'android=text("Add new profile")',
        holdToEditText: 'android=resourceId("com.philo.philo.google:id/tv_hold_to_edit")',
        philoLogo: 'android=resourceId("com.philo.philo.google:id/logo")',

        // Header
        homeHeader: 'android=resourceId("com.philo.philo.google:id/home_header")',
        userProfileIcon: 'android=resourceId("com.philo.philo.google:id/user_profile_icon")',
        ...
        topNavSettings: 'android=resourceId("com.philo.philo.google:id/tab_profile")',

        // Main Navigation
        liveTVButton: 'android=resourceId("com.philo.philo.google:id/live_tv_button")',
        onDemandButton: 'android=resourceId("com.philo.philo.google:id/on_demand_button")',
        dvrButton: 'android=resourceId("com.philo.philo.google:id/dvr_button")',
        ...
        // Movie Tiles
        firstMovieTile: 'android=new UiSelector().resourceId("com.philo.philo.google:id/list_view_broadcasts").childSelector(new UiSelector().className("android.view.ViewGroup").instance(0))',
        movieTileTitle: 'android=resourceId("com.philo.philo.google:id/title")',

        // Series Tiles
        topFreeShowsRow: 'android=resourceId("com.philo.philo.google:id/group_header_text")',
        topFreeShowsText: 'android=text("Top Free Shows")',
        firstSeriesTile: 'android=new UiSelector().resourceId("com.philo.philo.google:id/widget_tile_wrapper").instance(6)',
        seriesTileTitle: 'android=resourceId("com.philo.philo.google:id/title")',

        // Featured Content
        featuredShow: 'android=resourceId("com.philo.philo.google:id/featured_show")',
        featuredMovie: 'android=resourceId("com.philo.philo.google:id/featured_movie")',
    ...
    private async sendKeyEvent(keycode: number): Promise<void> {
        try {
            // Get device type and ID from AppHelper
            const deviceType = AppHelper.deviceType;
            if (!deviceType) {
            ...
            return new Promise((resolve, reject) => {
                exec(`adb -s ${deviceId} shell input keyevent ${keycode}`, (error, stdout, stderr) => {
                    if (error) {
