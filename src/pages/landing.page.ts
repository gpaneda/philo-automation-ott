...
export class LandingPage extends BasePage {
    private readonly LANDING_PAGE_ELEMENTS = 'android=resourceId("com.philo.philo:id/landing_page_elements")';
    private readonly CHANNELS_LIST = 'android=resourceId("com.philo.philo:id/channels_list")';
    private readonly EXPLORE_FREE_CHANNELS_BUTTON = 'android=resourceId("com.philo.philo:id/explore_free_channels_button")';
    private readonly LOGIN_SCREEN = 'android=resourceId("com.philo.philo:id/login_screen")';
