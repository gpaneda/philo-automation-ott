...
class SearchPage extends base_page_1.BasePage {
    constructor(driver) {
        ...
        this.defaultTileRow = 'com.philo.philo:id/default_tile_row';
        ...
        this.labelTileGroup = 'com.philo.philo:id/label_tile_group';
        this.listViewBroadcasts = 'com.philo.philo:id/list_view_broadcasts';
        this.widgetTileWrapper = 'com.philo.philo:id/widget_tile_wrapper';
        this.tileViewWrapper = 'com.philo.philo:id/tile_view_wrapper';
        this.tileView = 'com.philo.philo:id/tile_view';
        this.pressedOverlay = 'com.philo.philo:id/pressed_overlay';
        this.channelLogo = 'com.philo.philo:id/channel_logo';
        this.favoriteIcon = 'com.philo.philo:id/favorite_icon';
        this.backgroundImage = 'com.philo.philo:id/background_image';
        this.iconPlayRadial = 'com.philo.philo:id/icon_play_radial';
        this.title = 'com.philo.philo:id/title';
        this.expandToGridIcon = 'com.philo.philo:id/expand_to_grid_icon';
        // Initialization code
        this.driver = driver;
    }
    ...
    async navigateToSearchAndVerify() {
        const homeScreen = new homescreen_page_1.HomeScreenPage(this.driver);
